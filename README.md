...
| [AceBook - Dart (Facebook Challenge)](http://http://team-dart.herokuapp.com/) | GitHub repo <a href="https://github.com/ddregalo/instagram-challenge">HERE</a>. Facebook-inspired post sharing social web application with a darts theme. Group Project with 5 developers working with Ruby on Rails for the first time. My Role - implementing basic post features, comments, testing, setup Amazon S3 Bucket for saving user avatars (Paperclip gem), implement Devise for user authentication, frontend jQuery as well as CSS styling. | Ruby on Rails, AWS S3, jQuery, HTML, CSS | Rspec-rails, SimpleCov, Travis-CI, Rubocop, CodeClimate |
